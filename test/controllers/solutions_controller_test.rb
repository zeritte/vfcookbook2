...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post solutions_url, params: { solution: { after_de: @solution.after_de, after_en: @solution.after_en, before_de: @solution.before_de, before_en: @solution.before_en, description: @solution.description, vf_case_id: @solution.vf_case_id } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { after_de: @solution.after_de, after_en: @solution.after_en, before_de: @solution.before_de, before_en: @solution.before_en, description: @solution.description, vf_case_id: @solution.vf_case_id } }
