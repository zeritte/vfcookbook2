...
class SolutionsTest < ApplicationSystemTestCase
  ...
  test "creating a Solution" do
    ...
    fill_in "After de", with: @solution.after_de
    fill_in "After en", with: @solution.after_en
    fill_in "Before de", with: @solution.before_de
    fill_in "Before en", with: @solution.before_en
    fill_in "Description", with: @solution.description
    fill_in "Vf case", with: @solution.vf_case_id
